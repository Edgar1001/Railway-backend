...
router.get("/today", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield db_1.pool.query(`SELECT * FROM activities WHERE date = $1 ORDER BY start_time ASC`, [date]);
...
router.get("/month", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield db_1.pool.query(`SELECT * FROM activities WHERE date BETWEEN $1 AND $2 ORDER BY start_time ASC`, [startOfMonth.toISOString().split("T")[0], endOfMonth.toISOString().split("T")[0]]);
        res.json({ activities: result.rows });
    }
    catch (error) {
        console.error(error);
...
router.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield db_1.pool.query("INSERT INTO activities (date, activity_name, start_time, duration_minutes) VALUES ($1, $2, $3, $4)", [date, activityName, startTime, durationMinutes]);
...
router.get("/weekly", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const currentWeek = (0, dayjs_1.default)(currentDate).week(); // Current week number of the year
       ...
       ORDER BY date ASC, start_time ASC`, [currentWeek, previousWeek, weekBeforePrevious]);
